...
public class Trabajo3 {
    ...
    public static void ejerc3() {
        ...
        double[] promedioEstudiante = new double[100];
    ...
    if(cantidadestudiantes > 0){
        ...
        JOptionPane.showMessageDialog(null, "Estudiantes aprobados:\n" + aprobados);
        JOptionPane.showMessageDialog(null, "Estudiantes reprobados:\n" + reprobados);
